...
Rectangle {
        ...
        ColumnLayout {
            ...
            AppCard {
                ...
                GridLayout {
                    ...
                    StatKar { etiq: "En cola";      n: kar.resumen.en_cola      || 0; tono: "info";    fId: "en_cola";
            ...
            AppCard {
                ...
                Rectangle {
                    ...
                    RowLayout { anchors.fill: parent; anchors.leftMargin: UiTokens.spacing10; anchors.rightMargin: UiTokens.spacing10; spacing: UiTokens.spacing8
                        ...
                        AppText { text: "Estado"; color: raiz.tema.textoMuted; font.pixelSize: UiTokens.fontSizeXs; font.weight: Font.Bold; width: raiz.colEstado }
                        AppText { text: "Progreso"; color: raiz.tema.textoMuted; font.pixelSize: UiTokens.fontSizeXs; font.weight: Font.Bold; width: raiz.colProgreso; visible: raiz.mW && kar.filtro_estado === "en_cola" }
                        AppText { text: "Dur."; color: raiz.tema.textoMuted; font.pixelSize: UiTokens.fontSizeXs; font.weight: Font.Bold; width: raiz.colDuracion; horizontalAlignment: Text.AlignRight; visible: raiz.mW }
                        AppText { text: "Acciones"; color: raiz.tema.textoMuted; font.pixelSize: UiTokens.fontSizeXs; font.weight: Font.Bold; width: raiz.colAcciones; horizontalAlignment: Text.AlignRight }
                    }
                }
    ...
    component FilaDelegate: Rectangle {
        ...
        RowLayout {
            ...
            StatusBadge { tema: raiz.tema; text: raiz._etiq(fd.kest); tone: raiz._tono(fd.kest); compact: true; maxTextWidth: raiz.colEstado - 4; width: raiz.colEstado }
            ...
            AppText { text: raiz._dur(fd.dur); color: raiz.tema.textoMuted; font.pixelSize: UiTokens.fontSizeSm; width: raiz.colDuracion; horizontalAlignment: Text.AlignRight; visible: raiz.mW }
            FilaAcciones { fd_pid: fd.pid; fd_titulo: fd.titulo; fd_kest: fd.kest; width: raiz.colAcciones }
        }
    }
    ...
    component FilaAcciones: Item {
        ...
        Row {
            ...
            AccBtn { texto: "Sacar de cola"; tono: "warning";
                ...
                onClicked: kar.sacar_de_cola(_ac.fd_pid) }
