                ...
                ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            ...
                            BotonPrimario {
                                visible: dependencias.hayInstalablesPendientes || dependencias.instalandoTodo
                                texto: dependencias.instalandoTodo ? "Instalando…" : "Instalar todo"
                                deshabilitado: dependencias.instalandoTodo
                                width: 180
                                height: 40
                                onClicked: dependencias.instalarTodo()
                            }
                            BotonSecundario {
