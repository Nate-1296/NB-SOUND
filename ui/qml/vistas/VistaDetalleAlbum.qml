        ...
        ColumnLayout {
            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    // El ancho debe coincidir EXACTO con la columna de acciones de
                    // cada fila (RowLayout de 348) para que "Título" no se ensanche
                    // de más y "Duración" quede alineada con los tiempos.
                    AppText { text: "Acciones"; font.pixelSize: UiTokens.fontSizeSm; font.weight: Font.DemiBold; color: tema.textoMuted; Layout.preferredWidth: 348; horizontalAlignment: Text.AlignHCenter }
                }
            }
                    ...
                    RowLayout {
                        ...
                        RowLayout {
                            ...
                            Rectangle {
                                ...
                                radius: 18
                                color: moreMouse.containsMouse ? tema.hover : "transparent"
                                border.color: tema.borde
                                border.width: 1
                                ThemedIcon {
                                    anchors.centerIn: parent
                                    width: 16; height: 16
                                    source: "../assets/icons/more-vertical.svg"
                                    iconColor: tema.textoSec
                                    iconOpacity: 0.72
                                }
                                MouseArea {
                                    ...
                                    onClicked: menuAgregarPlaylist.abrir(
                                        modelData.id,
                                        modelData.titulo || modelData.nombre_archivo || "Canción")
                                }
                            }
                            AlbumActionButton {
                                primary: true
