...
Rectangle {
    ...
    function abrirMenuPlaylist(pista) {
        if (!pista || !pista.id)
            return
        menuAgregarPlaylist.abrir(pista.id, _pistaTitulo(pista))
    }
            ...
            ColumnLayout {
                ...
                Component {
                    ...
                    SearchTrackRow {
                        ...
                        onAddToPlaylist: function(p) { abrirMenuPlaylist(p) }
                    }
                }
                    ...
                    delegate: ColumnLayout {
                        ...
                        Repeater {
                            ...
                            delegate: SearchTrackRow {
                                ...
                                onAddToPlaylist: function(pista) { abrirMenuPlaylist(pista) }
                            }
                        }
                    }
                }
    ...
    component SearchTrackRow: Rectangle {
        ...
        signal addToPlaylist(var pista)
        ...
        RowLayout {
            ...
            RowLayout {
                ...
                SearchIconButton {
                    ...
                    onClicked: trackRow.addToPlaylist(trackRow.pista)
                }
            }
        }
    }
