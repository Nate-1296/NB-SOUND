...
Rectangle {
    ...
    readonly property int lado_marca_nav: minimo_vertical ? 78 : (estrecho_vertical ? 106 : (compacto_vertical ? 137 : 167))
    readonly property int margen_marca_nav: minimo_vertical ? 2 : (estrecho_vertical ? 4 : 6)
    ...
    ScrollView {
        ...
        ColumnLayout {
            ...
            ColumnLayout {
                ...
                // Marca de la app: el emblema (silueta + wordmark "NB SOUND")
                // reemplaza al título textual. Llena el ancho disponible de la
                // barra (cuadrado, sin deformar) para verse grande y nítido; el
                // contenedor abraza el logo y solo deja un margen vertical breve
                // para no pegarlo al resto.
                Image {
                    id: marca_logo
                    Layout.alignment: Qt.AlignHCenter
                    Layout.topMargin: raiz.margen_marca_nav
