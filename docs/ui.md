...
63 paletas predefinidas (oscuras, claras, neutras y editoriales) más un tema personalizado donde defines tus propios colores. Todas tienen contraste WCAG calculado dinámicamente: el color del texto sobre cada acento se ajusta solo según la luminancia para que nunca quede ilegible.
